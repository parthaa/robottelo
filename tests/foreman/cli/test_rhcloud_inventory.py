...
def test_positive_sync_inventory_status_cli(
    ...
    """
    org = rhcloud_manifest_org
    result = module_target_sat.cli.Insights.inventorySync({'organization-id': org.id})
...
def test_positive_cloud_connector_enable_cli(module_target_sat):
    ...
    """
    result = module_target_sat.cli.Insights.cloudConnectorEnable({})
...
def test_positive_generate_reports_job_cli(
    ...
    result = module_target_sat.cli.Insights.fetchLastUploadLog({'organization-id': org.id})
...
def test_positive_generate_reports_job_cli_disconnected(
    ...
    result = module_target_sat.cli.Insights.fetchLastUploadLog(
        {
...
def test_positive_download_reports_job_cli_disconnected(
    ...
    result = module_target_sat.cli.Insights.inventoryDownloadReport(
        {
            'organization-id': org.id,
            'path': "/tmp",
        }
...
def generate_report(rhcloud_manifest_org, module_target_sat, disconnected=False):
    ...
    :id: e66f9896-f16d-471e-a269-d11542a797fe

    :steps:
        1. Execute hammer insights inventory download-report.
    ...
    result = module_target_sat.cli.Insights.inventoryGenerateReport(params)
    ...
    assert task_output[0].result == "success"
    report_log = module_target_sat.cli.Insights.fetchLastReportLog({'organization-id': org.id})
